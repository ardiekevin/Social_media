...
try:
    ...
    worksheet = sheet.worksheet(' *Daily_Data (Aff)')
...
for file_name in csv_files:
    try:
        ...
        columns_to_keep = ['Affiliate Username', 'Currency', 'Registered Users', 
                           'Number of First Deposits', 'First Deposit', 'Active Players']
...
if all_data:
    ...
    # Update Google Sheet
    try:
        worksheet.update(range_name=f'A{last_row + 1}', values=final_df.values.tolist())
    except Exception as e:
